...
namespace Sharpdev.SDK.Testing
{
    ...
    /// </summary>
    public sealed class EmailAddressObjectGenerator : TestObjectGeneratorBase<IConfirmed<EmailAddress>>
    {
        /// <summary>
        ...
        public EmailAddressObjectGenerator(EmailAddress emailAddress)
        {
        ...
        /// <returns>Строитель для объекта <see cref="IConfirmed{TConfirmedObject}" />.</returns>
        public EmailAddressObjectGenerator Confirmed(DateTime confirmedDate)
        {
